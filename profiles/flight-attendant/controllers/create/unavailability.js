angular.module('create-flight-attendant-unavailability-controller', []);
angular.module('create-flight-attendant-unavailability-controller', [])
  .controller('createFlightAttendantUnavailabilityCtrl', function ($scope, traitInitializer, simpleStorage, localStorageService, nestedObjectHandler, simpleSave, $rootScope, profileDataManagement, $ionicHistory, EditProfileRouter) {
    ...
    $scope.readUnavailableDays = function () {
      ...
      for (key in unavailable_days_attributes) {
