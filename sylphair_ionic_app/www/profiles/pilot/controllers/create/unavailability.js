angular.module('create-pilot-unavailability-controller', []);
angular.module('create-pilot-unavailability-controller', [])
  .controller('CreatePilotUnavailabilityCtrl', function ($scope, traitInitializer, simpleStorage, localStorageService, nestedObjectHandler, simpleSave, $rootScope, profileDataManagement, $ionicHistory, EditProfileRouter) {

    // $scope.createPilot = simpleStorage.getter('createPilot');
