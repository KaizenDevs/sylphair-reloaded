angular.module('pilot-my-jobs-controller', []);
angular.module('pilot-my-jobs-controller')
  .controller('JobsAppliedPilotCtrl', function ($scope, User, localStorageService, Utils, $ionicLoading, ViewJobsService, $location) {
    $ionicLoading.show();
